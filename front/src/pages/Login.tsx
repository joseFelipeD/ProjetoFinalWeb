      ...
      <div className="mx-auto flex min-h-[calc(100vh-48px)] max-w-7xl items-center justify-between gap-12">
        <section className="hidden max-w-2xl lg:block">
          <div className="mb-28">
            <Brand
              name="EduInsight IA"
              subtitle="plataforma pedagógica"
              size="md"
            />
          </div>
          ...
          <h1 className="mt-8 text-5xl font-black leading-tight">
            Transforme observações pedagógicas em decisões de aula.
          </h1>

          <p className="mt-5 text-lg leading-8 text-blue-100/80">
            Registre situações das turmas do 6º ao 9º ano, acompanhe padrões e
            simule relatórios pedagógicos com apoio de IA.
          </p>
          ...
          <div className="mt-9 grid grid-cols-3 gap-4">
            {[
              ...
              "Analise padrões",
              "Planeje intervenções",
            ].map((text) => (
              <div
                key={text}
                className="rounded-2xl border border-white/10 bg-white/8 p-4 text-sm font-semibold text-blue-50"
              >
                {text}
              </div>
            ))}
        ...
        <section className="mx-auto w-full max-w-md rounded-3xl bg-white p-8 text-ink shadow-2xl">
          ...
          <p className="mt-6 border-t border-slate-100 pt-5 text-center text-xs text-slate-400">
            Seguro • Gratuito • Focado em professores
          </p>
        </section>
      </div>
    </main>
